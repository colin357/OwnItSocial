...
import LeadForm from '../keepplaying/LeadForm';
...
// ---------------------------------------------------------------------------
// /calendar — the landing page for Fairway loan officers we meet at the
// Fairway Regional Meeting. It is /keepplaying with the event name swapped.
//
...
export const metadata: Metadata = {
  title: 'Own It Social at the Fairway Regional Meeting — marketing for Fairway loan officers',
  description:
    'Own It Social is the done-for-you marketing department for Fairway loan officers: social content, Total Expert follow-up, and Google presence. Book a free strategy session.',
  alternates: { canonical: 'https://ownitsocial.com/calendar' },
  openGraph: {
    title: 'Own It Social at the Fairway Regional Meeting — marketing for Fairway loan officers',
    description:
    ...
    url: 'https://ownitsocial.com/calendar',
    type: 'website',
  },
};
...
export default function FairwayRegionalMeetingPage() {
  ...
  return (
    ...
    // conversation starts.
    <BookingProvider
      modal={<LeadForm source="fairway-regional-meeting" />}
      title="Request your free strategy session"
      source="fairway-regional-meeting"
    >
      <script
      ...
      <div id="top" className="min-h-screen bg-white font-montserrat text-ink antialiased">
        <Nav
          ...
          announcement={{
            message: 'Fairway Regional Meeting. Fairway loan officers:',
        ...
        <Hero eyebrow="Fairway Regional Meeting" />
          ...
          <div className="mx-auto max-w-[1400px]">
            <Reveal>
              <p className="font-display text-[12px] font-bold uppercase tracking-[0.14em] text-white/70">
                Fairway loan officers at the Regional Meeting
              </p>
