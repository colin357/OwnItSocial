...
export const metadata: Metadata = {
  alternates: { canonical: 'https://ownitsocial.com/mbanj' },
  title: 'NJMBA Regional Conference Special - Own It Social | $995/mo Marketing for Loan Officers',
  description: 'Exclusive NJMBA Regional Conference offer: Complete done-for-you marketing for loan officers at $995/mo (normally $1,500/mo). Content, CRM follow-ups, and lead generation.',
  keywords: [
    'njmba loan officer marketing',
    'mortgage marketing',
  ...
  openGraph: {
    title: 'NJMBA Regional Conference Special - Own It Social',
...
export default function NJMBAConferencePage() {
  ...
  const localBusinessSchema = generateLocalBusinessSchema({
    name: 'Own It Social - NJMBA Loan Officer Marketing',
    address: {
      street: '',
      city: 'Miami',
      state: 'FL',
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Secure your conference pricing ($995/mo) with a quick checkout. Locks in your spot immediately.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="pricing" className="bg-gradient-to-r from-purple-600 to-blue-600 py-20 md:py-32">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
              NJMBA Conference Special Pricing
            </h2>
            ...
            <div className="bg-white rounded-3xl p-12 shadow-2xl max-w-2xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-lg font-semibold text-purple-600">Save $505/month with conference pricing</p>
              </div>

              <div className="bg-purple-50 rounded-2xl p-6 mb-8">
                <p className="text-sm font-bold text-purple-900 mb-3">Limited Conference Spots</p>
                <p className="text-sm text-gray-700">
                  This special pricing is only available to NJMBA conference attendees. Once spots fill, pricing returns to standard rate.
                </p>
              </div>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          ...
          <div className="space-y-6">
            ...
            <details className="bg-white rounded-2xl p-6 shadow-lg group">
              <summary className="font-bold text-lg text-gray-900 cursor-pointer list-none flex justify-between items-center">
                Is the conference price locked in?
                <svg className="w-5 h-5 text-purple-600 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Yes! As long as you maintain an active subscription, your $995/month rate is locked in permanently. This pricing is exclusive to NJMBA conference attendees and won&apos;t be offered again.
              </p>
            </details>
        ...
        <footer className="bg-gray-900 text-gray-400 py-12 border-t border-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center text-sm border-t border-gray-800 pt-8">
              <p>&copy; 2025 OwnItSocial.com | NJMBA Regional Conference Exclusive | All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
