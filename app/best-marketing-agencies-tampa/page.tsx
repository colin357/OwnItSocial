...
import { tampaCompetitors, ownItSocial } from '@/app/data/competitors';

export const metadata: Metadata = {
  alternates: { canonical: 'https://ownitsocial.com/best-marketing-agencies-tampa' },
  title: 'Best Marketing Agencies in Tampa, FL 2025 | Independent Comparison',
  description: 'Unbiased comparison of the top marketing agencies in Tampa, Florida. Compare pricing, services, and reviews to find the perfect fit for your business.',
  keywords: 'best marketing agencies tampa, top marketing agencies tampa fl, tampa marketing companies, marketing firms tampa florida',
};

export default function BestMarketingAgenciesTampaPage() {
  const allAgencies = [ownItSocial, ...tampaCompetitors];

  const articleSchema = generateArticleSchema({
    headline: 'Best Marketing Agencies in Tampa, FL 2025',
    description: 'Unbiased comparison of the top marketing agencies in Tampa, Florida. Compare pricing, services, and reviews to find the perfect fit for your business.',
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Best Marketing Agencies in Tampa, FL 2025', url: '/best-marketing-agencies-tampa' },
  ]);
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-8 text-gray-700 leading-relaxed">
            An honest, unbiased comparison of Tampa&apos;s top marketing agencies to help you make the right choice for your business.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 border border-purple-100">
          ...
          <p className="text-gray-700 mb-4">
            We&apos;ve researched Tampa&apos;s most prominent marketing agencies based on:
          </p>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-700">
              Marketing agencies in Tampa range from $2,000/month to $12,000+/month. Know your budget before you start shopping.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-500 mb-4">
                Marketing agency specializing in real estate and finance marketing, serving Tampa Bay and beyond.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/best-marketing-agencies-tampa" className="hover:text-white transition">Best Agencies Tampa</Link></li>
          ...
          <div className="text-center text-sm border-t border-gray-800 pt-8">
            <p>© 2025 OwnItSocial.com | Serving Tampa, FL | All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
